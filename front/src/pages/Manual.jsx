  ...
  return (
    <div className="manual-container">
      ...
      <div className="manual-content">
        ...
        <section className="manual-section">
          <h2>🔍 優先度フィルター機能</h2>
          <p>TODO一覧を優先度で絞り込むことができます：</p>
          <ol>
            <li>TODO一覧の上部にある「優先度で絞り込み」のドロップダウンリストを選択</li>
            <li>「選択なし」「低」「中」「高」から絞り込みたい優先度を選択</li>
            <li>選択した優先度のTODOのみが一覧に表示されます</li>
            <li>「選択なし」を選択すると、全てのTODOが表示されます</li>
          </ol>
          <p className="note">※ フィルターは即座に反映され、選択を変更するとリアルタイムで表示が更新されます。</p>
        </section>
        ...
        <section className="manual-section">
          ...
          <ul>
            ...
            <li>優先度フィルターを使うと、特定の優先度のTODOだけを素早く確認できます</li>
